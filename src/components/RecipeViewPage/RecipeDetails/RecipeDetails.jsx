  ...
  return (
    <>
      ...
      <div className={styles.wrapperImg}>
        ...
        <h1 className={styles.title}>{recipe.title || "Без назви"}</h1>
      </div>
...
//           <button
//             type="button"
//             className={clsx(styles.saveButton, isFavorite && styles.iconSaveFavorite)}
//             onClick={handleFavoriteClick}
...
//                       <p>
//                         <span className={styles.ingname}>
//                           {ingredient ? ingredient.name : "Невідомий інгредієнт"} -{" "}
//                         </span>
//                         {item.measure || "-"}
//                       </p>
//                     </li>
